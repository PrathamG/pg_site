...
<body style = 'background-color:white; padding-bottom: 0px;'>
	...
	<form class = 'btm-container' action = "<?= htmlspecialchars($_SERVER['PHP_SELF']); ?>" method = 'post'>
		...
		<div><input type = 'text' class = 'login-input' name = 'username' value = "testuser@gmail.com"></div>
		<div class = 'login-label'>Password:</div>
		<div><input type = 'password' class = 'login-input' name = 'password' value = "testpass"></div>
